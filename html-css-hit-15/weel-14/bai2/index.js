...
mainTitle.innerHTML = "Danh sách sản phẩm";
...
item.forEach(item => {
    item.addEventListener("click", () => {
        ...
        body.insertBefore(divOverlay,container);

        const div = document.createElement("div");
        const clickedTitle = item.querySelector(".title").textContent;

        const product = products.find(p => p.title === clickedTitle);
