...
function handleClickLixi() {
  ...
  const chucMungMessages = [
    '🎉 Chúc mừng năm mới! Chúc bae một năm tràn đầy niềm vui, sức khỏe dồi dào và thành công vượt bậc! 🎆',
    '🌸 Tết đến xuân về, chúc em iu vạn sự như ý, mọi khó khăn đều qua đi, chỉ còn lại niềm vui và hạnh phúc! 🌟',
    '💰 Chúc em bé của anh năm mới an khang thịnh vượng, gia đình ấm no, và luôn gặp may mắn trên mọi nẻo đường! 🍀',
    '❤️ Năm mới, chúc baby đón nhận thật nhiều yêu thương, hạnh phúc ngập tràn và sức khỏe mãi vững bền! 🌈',
    '🌟 Chúc Em yêuu một năm mới thật rực rỡ, mọi dự định đều thành công, và những khoảnh khắc tuyệt vời luôn bên bạn! 🎊',
    '🎁 Chúc vợ iuuu năm mới phát tài phát lộc, mọi công việc đều thuận lợi, gia đình hạnh phúc và vui vẻ! 🏡',
  ];
  ...
  const lixiMessages = [
    ...
    'Xin 20k nhé 💶',
    'Xin 50k nhé 💷',
    'gửi cho anh một tình iu siu to nhé ❤️',
  ];
